            ...
            <div class="card-body px-0 pb-2">
                <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tasks
                                </th>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <i class="fa fa-tasks me-3 text-info" aria-hidden="true"></i>
                                        </div>
                            ...
                            <tr>
                                ...
                                <div class="d-flex px-2 py-1">
                                    <div>
                                        <i class="fa fa-users me-3 text-info" aria-hidden="true"></i>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Referral</h6>
                                    </div>
</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <div class="d-flex px-2 py-1">
                                    <div>
                                        <i class="fa fa-star me-3 text-info" aria-hidden="true"></i>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">Top Posts</h6>
                                    </div>
</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <i class="fa fa-chart-line me-3 text-info" aria-hidden="true"></i>
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">Post Performance</h6>
                                        </div>
